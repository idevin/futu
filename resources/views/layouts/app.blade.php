...
{{--    @foreach(parseMix('css') as $alias => $file)--}}
...
<div class="grid-x grid-padding-x">
    <div class="cell small-6 in-view-x" data-translate="Y" data-from="600" data-to="0">
        <a href="#" class="grayed">
            <img src="/images/projects/SideHustle_Seltzer_Futu_Packeging.png">
        </a>
        <br/> <br/>
        <b>Side Hustle Brews</b><br/>
        <b>Brewery. Brooklyn USA</b><br/>
        <span class="annotation">Packaging Design + Promo Materials</span> <br/>
        <span class="annotation">2019</span>
    </div>
    <div class="cell small-6 in-view-x" data-from="-500" data-top="0">
        <a href="#" class="grayed">
            <img src="/images/projects/IG_gallery.png">
        </a>
        <br/> <br/> <b>IG Gallery</b><br/>
        <b>Art Gallery. Paris FRANCE</b><br/>
        <span class="annotation">Posters + Promo Materials</span><br/>
        <span class="annoKation">2016</span>
    </div>
</div>
...
<div class="grid-x grid-padding-x" style="align-items: center;  justify-content: center;">
    ...
    <div class="cell small-6 in-view-x" data-from="-400" data-to="0" style="text-align: center;">
        <b><a href="#" class="gray-link">More Projects</a></b>
    </div>
</div>
...
<div class="grid-x grid-margin-x grid-padding-x align-center img-clients in-view-x" data-from="-300" data-to="0">
    <div class="cell auto">
...
<div class="grid-x grid-margin-x grid-padding-x align-center img-clients in-view-x" data-from="500" data-to="0">
    <div class="cell auto">
