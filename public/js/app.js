...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* unused harmony exports Abide, Accordion, AccordionMenu, Box, Core, CoreUtils, Drilldown, Dropdown, DropdownMenu, Equalizer, Foundation, Interchange, Keyboard, Magellan, MediaQuery, Motion, Move, Nest, OffCanvas, Orbit, ResponsiveAccordionTabs, ResponsiveMenu, ResponsiveToggle, Reveal, Slider, SmoothScroll, Sticky, Tabs, Timer, Toggler, Tooltip, Touch, Triggers, onImagesLoaded */
...
/******/ 			if (chunkId === "resources_sass_app_sass") return "js/" + chunkId + ".js";
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "futu.concepts:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkfutu_concepts"] = self["webpackChunkfutu_concepts"] || [];
...
Promise.all(/*! import() */[__webpack_require__.e("css/app"), __webpack_require__.e("resources_sass_app_sass")]).then(__webpack_require__.bind(__webpack_require__, /*! ../sass/app.sass */ "./resources/sass/app.sass"));
...
in_view__WEBPACK_IMPORTED_MODULE_0___default()('.in-view-x').on('enter', function (e) {
  ...
  return (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(params);
});
jQuery('.dot').center();
jQuery('.fullscreen').center();
var foundation = foundation_sites__WEBPACK_IMPORTED_MODULE_2__["default"];
var topMenu = jQuery('.top-menu');

var animateTopmenu = function animateTopmenu(from, to) {
  return (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])({
...
var tl = animejs__WEBPACK_IMPORTED_MODULE_1__["default"].timeline().add({
  targets: '.dot',
  keyframes: [{
    opacity: [0, 1],
    duration: 100
...
function showMenu() {
  ...
  if (wWidth < 651) {
    setTimeout(function () {
      (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(params2);
    }, 1000);
  } else {
    (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(params3);
  }
}
...
jQuery(document).ready(function () {
  ...
  offCannvas.on('opened.zf.offCanvas', function () {
    ...
    (0,animejs__WEBPACK_IMPORTED_MODULE_1__["default"])(options);
  });
